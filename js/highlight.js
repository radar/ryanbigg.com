...
var hljs=function(){"use strict";function e(t){
  ...
  },e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("http",(()=>{"use strict";function e(...e){
  ...
  },n.inherit(s,{relevance:0})]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
  ...
  begin:s+n+"$"}]}}})());hljs.registerLanguage("objectivec",(()=>{"use strict";return e=>{
  ...
  begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}})());hljs.registerLanguage("ruby",(()=>{"use strict";function e(...e){
  return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
  })).join("")}return n=>{
  const a="([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)",i={
  ...
  begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
  ...
  name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("erb",(()=>{"use strict";return e=>({name:"ERB",
  subLanguage:"xml",contains:[e.COMMENT("<%#","%>"),{begin:"<%[%=-]?",
  end:"[%-]?%>",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0}]})})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
  ...
  },contains:[c]}]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
  ...
  begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
  return e?"string"==typeof e?e:e.source:null}function n(e){return a("(?=",e,")")}
  ...
  },...B,...k,...S,I,K,...z,...q,U,G]}}})());hljs.registerLanguage("rust",(()=>{"use strict";return e=>{
  ...
  name:"TypeScript",aliases:["ts","tsx"]}),b}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
  return e?"string"==typeof e?e:e.source:null}function n(...n){
  return n.map((n=>e(n))).join("")}function t(...n){
  return"("+n.map((n=>e(n))).join("|")+")"}return e=>{
  ...
  contains:p}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
  ...
  },{className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,c,t]}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
  ...
  className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
  aliases:["pycon"],contains:[{className:"meta",starts:{end:/ |$/,starts:{end:"$",
  subLanguage:"python"}},variants:[{begin:/^>>>(?=[ ]|$)/},{
  begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
  name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
  ...
  },{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
