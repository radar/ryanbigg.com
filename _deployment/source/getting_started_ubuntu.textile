...
In this guide, we'll be using the "Ticketee":http://github.com/rails3book/ticketee application from <a href='http://manning.com/katz'>Rails 3 in Action</a> as an example. The "application is freely available":https://github.com/rails3book/ticketee on GitHub.

The majority of this guide is also covered in the "official Capistrano guide":https://github.com/capistrano/capistrano/wiki/2.x-From-The-Beginning, which may provide some additional insight. This guide provides a concise walkthrough of every command that we'll use to set up a server.
