...
The desk is a sit / stand desk I bought brand new from an office supply store in town. I don't remember the brand. I commonly use it in the "sit" mode and when I'm feeling adventurous or tired of sitting down, I'll raise it up.
...
The Herman Mirra 2 chair has lasted at least 5 years so far and for that price range of the chair I'd be expecting to get at least another decade out of it.

## Laptop: Apple MacBook Pro (M1, 2021)

Work-issued laptop that I use the majority of the time. On one side there's a dongle because Apple is, unbeknownst to most, foremost a dongle company. Three of three USB-C plugs are occupied: two for the monitors and one for the dongle. Both of the monitors provide power to the laptop through their USB-C cables, eliminating the need for the power cable to ever be connected.

The dongle is a [USB-C Digital AV Multiport Adapter](https://www.apple.com/au-hed/shop/product/MUF82ZA/A/usb-c-digital-av-multiport-adapter) -- and at $99AUD for a piece of plastic with some wires and chips is one of the more expensive cable options on the desk. This dongle connects to a USB-C KVM switch.

Periodically one of the USB-C connections needs to be freed up for me to connect in an iPhone for testing. It's usually a monitor that gets the boot.

## Monitors: Dell 27" UltraSharp

For my viewing pleasure I have a [27" 4K Dell Monitor](https://www.dell.com/en-au/shop/dell-27-4k-uhd-usb-c-monitor-s2722qc/apd/210-bccw/monitors-monitor-accessories) and a work-issued [27" 4k LG Monitor](https://www.lg.com/au/monitors/ultrafine-uhd-4k-5k/27ul850-w/). The screen differences don't bother me unless you make me think about them too deeply.

They're both mounted onto the desk via a dual arm monitor mount from the local office shop. I could've kept their stands but I use the space underneath the monitors to put things like the laptop and other peripherals.
...
I was using the [Kinesis Gaming Freestyle Edge RGB Split Mechanical Keyboard](https://www.amazon.com.au/KINESIS-Gaming-Freestyle-Mechanical-Keyboard/dp/B07SXX7P6D). I used to be a semi-pro gamer and the RGB lights on this make me relive my glory days.

I now use an [Ergodox EZ](https://ergodox-ez.com/) for its programmability. I wrote [a whole post on using this keyboard while using the keyboard](https://ryanbigg.com/2024/04/one-year-with-the-ergodox-ez). It's very, very good.
...
The split is about 45cm apart, and tilted slightly upwards at the back.
...
The keyboard is wired to the USB hub on my desk, which is in turn wired into the KVM, which is then wired into the laptop. I could've gone for a wireless keyboard to reduce cable clutter, but I hate the idea of having to always have (charged) batteries on hand.
...
Another benefit is that has a cable which plugs into the USB hub.
...
It turns out that mice do not like veneer surfaces that well and it really effects my kill-death ratio in gaming. Just kidding. I'm awesome all the time.
...
Not only does it decrease mouse issues, but it also makes the mouse _quieter_ on the desk. It is also incredibly good at catching and keeping cat hair.
...
The microphone is mounted to the desk with a [Rode PSA1 Professional Studio Boom Arm](https://www.scorptec.com.au/product/headphones/accessories/69834-psa1) almost directly above the right hand keyboard, so you can hear the mechanical switches very clearly and also my voice. Mounting it this way means I can swing it out of the way when I'm not using it. The microphone sits above the left-most monitor of the desk, which is the one I usually put calls onto.
...
The downside of this device is remembering to push the tiny button to switch the inputs back and wondering why your keyboard and mouse aren't working. It needs a bright dual-colour light to indicate what setting it's on -- instead it has something that's a dull almost unnoticeable blue.

The USB hub that most things connect into is [The Simplecom 10-port hub](https://www.inkstation.com.au/2601/48w-10port-usb-30-hub-and-charger-with-individual-switches-12v-4a-power-adapter-bc12-fast-charging-simplecom-chu810-p-21992.html). Even though I've only got four things connected into this (keyboard, mouse, webcam, and microphone) I come from a school of thought of "you can never have too many USB ports". The hub comes with its own power supply which is helpful as the laptop doesn't like providing power to 10 USB-A ports full of things by itself.

## Under the desk

Under the desk there was one [cable tray](https://www.amazon.com.au/dp/B0CGF39ZVM?ref=ppx_yo2ov_dt_b_fed_asin_title), and it was so useful that I ended up buying a second. Both have a powerboard in them full of gear. I can hide most of the cable mess down in those.
...
So I did some research (asked some people on a Slack group and Twitter) and it turns out some people get very excited about radio-wave-emitting little plastic boxes, and those people were excited about [the Unifi Lite Access Point](https://store.ui.com/collections/unifi-network-access-points/products/unifi-ac-lite).
